...
import com.gozon.orders.application.InvalidOrderRequestException;
import com.gozon.orders.application.OrderNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({InvalidOrderRequestException.class, MethodArgumentNotValidException.class})
