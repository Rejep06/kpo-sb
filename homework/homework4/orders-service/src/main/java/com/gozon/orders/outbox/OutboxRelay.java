...
/**
 * Periodically publishes outbox messages to the broker.
 *
 * NOTE: This provides at-least-once delivery; exactly-once semantics are achieved by consumer idempotency (Inbox).
 */
@Component
